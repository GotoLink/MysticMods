...
public class ItemHandler {
	...
	public static void init() {
		...
		verditeChestplate = new ItemArmorVerdite(EnumArmor.Verdite, 1).setUnlocalizedName(Strings.VERDITE_CHESTPLATE_NAME);
		...
		mithrilChestplate = new ItemArmorMithril(EnumArmor.Mithril, 1).setUnlocalizedName(Strings.MITHRIL_CHESTPLATE_NAME);
		...
		adamantineHelmet = new ItemArmorAdamantine(EnumArmor.Adamantine, 0).setUnlocalizedName(Strings.ADAMANTINE_HELMET_NAME);
		adamantineChestplate = new ItemArmorAdamantine(EnumArmor.Adamantine, 1).setUnlocalizedName(Strings.ADAMANTINE_CHESTPLATE_NAME);
		adamantineLeggings = new ItemArmorAdamantine(EnumArmor.Adamantine, 2).setUnlocalizedName(Strings.ADAMANTINE_LEGGINGS_NAME);
		adamantineBoots = new ItemArmorAdamantine(EnumArmor.Adamantine, 3).setUnlocalizedName(Strings.ADAMANTINE_BOOTS_NAME);
