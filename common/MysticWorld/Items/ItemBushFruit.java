...
public class ItemBushFruit extends ItemFood {
	...
	public ItemBushFruit(int health) {
		super(health, 0.6F, false);
	...
	public void registerIcons(IIconRegister iconRegister) {
		icons = new IIcon[FRUIT_TYPES.length];
		for (int i = 0; i < FRUIT_TYPES.length; ++i) {
			icons[i] = iconRegister.registerIcon("mysticworld:Fruit" + FRUIT_TYPES[i]);
		}
	}
