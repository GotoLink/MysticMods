...
public class PowerWaterFX extends EntityFX {
	public static final ResourceLocation waterFX = new ResourceLocation("mysticmods", "textures/misc/waterFX.png");
	...
	public void renderParticle(Tessellator tessellator, float par2, float par3, float par4, float par5, float par6, float par7) {
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(waterFX);
